...
AI Engineer focused on building production AI systems — multi-agent orchestration, computer vision pipelines, and retrieval-augmented generation. I've shipped systems ranging from real-time branch video analytics to LLM-orchestrated content generation pipelines. Currently available for freelance and contract work.
